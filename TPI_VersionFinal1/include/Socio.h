...
public:
    ...
    Socio(std::string nombre, std::string apellido, int dni, int idUsuario, Fecha fechaNacimiento, Fecha fechaIngreso, std::string contrasenia,
          bool estado, int idRol,int idMembresia, std::string estadoFisico, int idRutina, int idEntrenadorAsignado, int pinIngreso);
